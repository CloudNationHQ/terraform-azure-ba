locals {
  # derive the provider identity type string from the avm managed_identities interface
  batch_identity_type = var.batch.managed_identities == null ? null : join(", ", compact([
    coalesce(var.batch.managed_identities.system_assigned, false) ? "SystemAssigned" : "",
    length(coalesce(var.batch.managed_identities.user_assigned_resource_ids, [])) > 0 ? "UserAssigned" : "",
  ]))

  # flatten pool -> jobs into a single keyed map for the batch_job resource
  batch_jobs = merge([
...
resource "azurerm_batch_account" "this" {
  ...
  dynamic "identity" {
    for_each = each.value.managed_identities != null ? { "this" = each.value.managed_identities } : {}

    content {
      type         = local.batch_identity_type
      identity_ids = identity.value.user_assigned_resource_ids
    }
  }

  dynamic "encryption" {
    for_each = each.value.customer_managed_key != null ? { "this" = each.value.customer_managed_key } : {}
  ...
  dynamic "key_vault_reference" {
    for_each = each.value.key_vault_reference != null ? { "this" = each.value.key_vault_reference } : {}
  ...
  dynamic "network_profile" {
    for_each = each.value.network_profile != null ? { "this" = each.value.network_profile } : {}
    ...
    content {
      dynamic "account_access" {
        ...
        content {
          ...
          dynamic "ip_rule" {
            for_each = account_access.value.ip_rule != null ? { for i, r in account_access.value.ip_rule : i => r } : {}
      ...
      dynamic "node_management_access" {
        ...
        content {
          ...
          dynamic "ip_rule" {
            for_each = node_management_access.value.ip_rule != null ? { for i, r in node_management_access.value.ip_rule : i => r } : {}
...
resource "azurerm_batch_application" "this" {
  ...
  account_name        = azurerm_batch_account.this["this"].name
...
resource "azurerm_batch_pool" "this" {
  ...
  dynamic "container_configuration" {
    ...
    content {
      ...
      dynamic "container_registries" {
        for_each = container_configuration.value.container_registries != null ? { for i, r in container_configuration.value.container_registries : i => r } : {}
  ...
  dynamic "data_disks" {
    for_each = each.value.data_disks != null ? { for i, d in each.value.data_disks : i => d } : {}
  ...
  dynamic "disk_encryption" {
    for_each = each.value.disk_encryption != null ? { for i, d in each.value.disk_encryption : i => d } : {}
  ...
  dynamic "extensions" {
    for_each = each.value.extensions != null ? { for i, e in each.value.extensions : i => e } : {}
  ...
  dynamic "mount" {
    for_each = each.value.mount != null ? { for i, m in each.value.mount : i => m } : {}
  ...
  dynamic "network_configuration" {
    ...
    content {
      ...
      dynamic "endpoint_configuration" {
        for_each = network_configuration.value.endpoint_configuration != null ? { for i, e in network_configuration.value.endpoint_configuration : i => e } : {}
        ...
        content {
          ...
          dynamic "network_security_group_rules" {
            for_each = endpoint_configuration.value.network_security_group_rules != null ? { for i, r in endpoint_configuration.value.network_security_group_rules : i => r } : {}
  ...
  dynamic "node_placement" {
    for_each = each.value.node_placement != null ? { for i, n in each.value.node_placement : i => n } : {}
    ...
    content {
      ...
      dynamic "container" {
        ...
        content {
          ...
          dynamic "registry" {
            for_each = container.value.registry != null ? { "this" = container.value.registry } : {}
      ...
      dynamic "resource_file" {
        for_each = start_task.value.resource_file != null ? { for i, f in start_task.value.resource_file : i => f } : {}
  ...
  dynamic "task_scheduling_policy" {
    for_each = each.value.task_scheduling_policy != null ? { for i, t in each.value.task_scheduling_policy : i => t } : {}
  ...
  dynamic "user_accounts" {
    for_each = each.value.user_accounts != null ? { for i, u in each.value.user_accounts : i => u } : {}
  ...
  dynamic "windows" {
    for_each = each.value.windows != null ? { for i, w in each.value.windows : i => w } : {}
...
resource "azurerm_role_assignment" "this" {
  for_each = var.batch.role_assignments != null ? var.batch.role_assignments : {}

  scope                                  = azurerm_batch_account.this["this"].id
  principal_id                           = each.value.principal_id
  role_definition_id                     = can(regex("/providers/Microsoft.Authorization/roleDefinitions/", each.value.role_definition_id_or_name)) ? each.value.role_definition_id_or_name : null
  role_definition_name                   = can(regex("/providers/Microsoft.Authorization/roleDefinitions/", each.value.role_definition_id_or_name)) ? null : each.value.role_definition_id_or_name
...
resource "azurerm_private_endpoint" "this" {
  ...
  private_service_connection {
    ...
    private_connection_resource_id = azurerm_batch_account.this["this"].id
...
resource "azurerm_monitor_diagnostic_setting" "this" {
  for_each = var.batch.diagnostic_settings != null ? var.batch.diagnostic_settings : {}

  name                           = coalesce(each.value.name, each.key)
  target_resource_id             = azurerm_batch_account.this["this"].id
